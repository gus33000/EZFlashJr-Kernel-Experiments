...
{
    inc_t func = (inc_t)0xD300;
    inc_t func2 = (inc_t)0xD400;
...
void setup_trampolines(void) NONBANKED
{
    memcpy((void *)0xD100, (void *)&ram_code, (uint16_t)object_distance(ram_code, ram_code_end));
    memcpy((void *)0xD200, (void *)&ram_code2, (uint16_t)object_distance(ram_code2, ram_code2_end));
    memcpy((void *)0xD300, (void *)&ram_code3, (uint16_t)object_distance(ram_code3, ram_code3_end));
    memcpy((void *)0xD400, (void *)&ram_code4, (uint16_t)object_distance(ram_code4, ram_code4_end));
}
